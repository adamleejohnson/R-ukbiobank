...
#'
#' @param instance_num An integer or string specifying the instance number, or the name of the column (using <[`data-masking`][dplyr_data_masking]> rules) containing instance numbers to use in the current function.
...
#' @param up_to_instance An integer or string specifying an instance number, or the name of the column (using <[`data-masking`][dplyr_data_masking]> rules) containing instance numbers to use as the **maximum instance (inclusive)**. Used to include all data **up to and including** the specified instance number.
